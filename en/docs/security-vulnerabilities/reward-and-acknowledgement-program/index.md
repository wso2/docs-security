...
!!! tip
    Please refer to our [Vulnerability Management Process]({{#base_path#}}/security-processes/vulnerability-management-process/) for more details about how we disclose security vulnerabilities.

We will do the following upon reporter's consent:

1. Include the reporter's name in the [Security Hall of Fame]({{#base_path#}}/security-vulnerabilities/reward-and-acknowledgement-program/hall-of-fame/) web page.
