...
For following **WSO2 Enterprise Integrator version 6.6.0, 6.5.0, 6.4.0, 6.3.0, and 6.2.0**, it is recommand to remove the following mappings in the <product_home>/conf/carbon.xml file from the <FileUploadConfig> section.
...
FOR following WSO2 API Manager versions 2.6.0, 2.5.0, 2.2.0,

It is recommand to Remove the following resource entry under <ResourceAccessControl> in the <product_home>/repository/conf/identity/identity.xml.
