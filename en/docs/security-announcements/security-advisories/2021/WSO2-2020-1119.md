...
<p class="doc-info">Published: February 8, 2021</p>
...
### DESCRIPTION
A Reflected Cross-Site Scripting (XSS) vulnerability can be exploited by sending an unauthenticated request with a malicious payload to the password reset component of the API Store Web Portal.
