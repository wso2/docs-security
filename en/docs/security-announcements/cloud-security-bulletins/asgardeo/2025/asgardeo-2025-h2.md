...
| ASG-2025-011 | Locked users can successfully log in through Magic Link authenticator | Medium | Without proper account state checks, locked users can bypass restrictions and log in using Magic Links or Pass Keys. This flaw grants unauthorized access to restricted accounts. |
